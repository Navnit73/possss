      ...
      <div style={{ width: rightWidth }} className="bg-white flex flex-col relative z-10 shrink-0">
        ...
        <div className="p-3 border-b border-border bg-surface shrink-0 relative">
          <div className="flex items-center bg-white border border-border rounded focus-within:ring-1 focus-within:ring-primary/50 focus-within:border-primary/50 min-h-[34px]">
            ...
            {selectedCustomer ? (
              <div className="flex-1 flex items-center justify-between bg-primary/10 mr-1 rounded pl-2 py-0.5 my-1 overflow-hidden">
                <span className="text-primary text-xs font-bold truncate">
                  {selectedCustomer.name}
                </span>
                <button 
                  onClick={() => { setSelectedCustomer(null); setCustomerSearchQuery(""); setCustomerSearchResults([]); }}
                  className="p-1.5 text-primary hover:text-red-500 transition-colors"
                >
