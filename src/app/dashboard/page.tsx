...
export default function DashboardPage() {
  ...
  const handleApplyFilter = (e?: React.FormEvent) => {
    ...
    if (dateRange === "custom" && (!startDate || !endDate)) {
      Swal.fire(
        "Warning",
        "Please select both start date and end date for custom date range.",
        "warning",
      );
      return;
    }
        ...
        >
          <div>
            ...
            <p className="text-xs text-zinc-500">
              Real-time store sales, inventory valuation, and cash flow
              analysis.
            </p>
          </div>
        ...
        <>
          ...
          <div className="grid grid-cols-2 md:grid-cols-5 border border-zinc-200 bg-white rounded-lg shadow-sm overflow-hidden divide-y md:divide-y-0 md:divide-x divide-zinc-200">
            <Link
              ...
              className="p-6 hover:bg-zinc-50 transition-colors block"
            >
            ...
            >
              ...
              <h3
                className={`text-3xl font-mono font-bold ${data.metrics.lowStockCount > 0 ? "text-rose-600" : "text-zinc-900"}`}
              >
            ...
            >
              ...
              <h3
                className={`text-3xl font-mono font-bold ${data.metrics.expiringSoonCount > 0 ? "text-amber-600" : "text-zinc-900"}`}
              >
                    ...
                    {data.topProducts.map((product: any, idx: number) => (
                      ...
                      >
                        <div className="flex items-center gap-2 min-w-0">
                          <span className="font-mono text-zinc-400 font-bold w-4">
                            #{idx + 1}
                          </span>
